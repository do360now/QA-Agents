...
**Advisory Pattern**: This agent uses the advisor pattern. It shells out to `claude-sonnet-4-6` when evidence attachment decisions are complex and before declaring the test run complete.
