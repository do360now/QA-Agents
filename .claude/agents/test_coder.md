...
**Advisory Pattern**: This agent uses the advisor pattern. It shells out to `claude-sonnet-4-6` when test structure decisions are ambiguous and before finalizing the test file.
